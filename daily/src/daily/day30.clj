...
(defn q164
  ...
  (and
    (= #{"a" "ab" "abc"}
       (set (ans '{:states #{q0 q1 q2 q3}
                  ...
                  :transitions {q0 {a q1}
                                ...
                                q2 {c q3}}})))
    (= #{"hi" "hey" "hello"}
       (set (ans '{:states #{q0 q1 q2 q3 q4 q5 q6 q7}
    ...
    (let [res (take 2000 (ans '{:states #{q0 q1}
                               :alphabet #{0 1}
                               :start q0
                               :accepts #{q0}
    ...
    (let [res (take 2000 (ans '{:states #{q0 q1}
      ...
      (and (every? (partial re-matches #"n*m") res)
           (= res (distinct res))))
    (let [res (take 2000 (ans '{:states #{q0 q1 q2 q3 q4 q5 q6 q7 q8 q9}
